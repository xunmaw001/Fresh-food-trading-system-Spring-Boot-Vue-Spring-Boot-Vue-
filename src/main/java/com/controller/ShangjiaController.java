...
public class ShangjiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ShangjiaEntity user = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("shangdianbianhao", username));
    ...
    public R register(@RequestBody ShangjiaEntity shangjia){
    	...
    	ShangjiaEntity user = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("shangdianbianhao", shangjia.getShangdianbianhao()));
		if(user!=null) {
