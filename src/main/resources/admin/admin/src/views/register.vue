      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">商店编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shangdianbianhao" class="input" type="text" placeholder="商店编号">
			   </div>
			 </div> -->
			<el-form-item label="商店编号" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangdianbianhao" autocomplete="off" placeholder="商店编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shangdianmingcheng" class="input" type="text" placeholder="商店名称">
			   </div>
			 </div> -->
			<el-form-item label="商店名称" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangdianmingcheng" autocomplete="off" placeholder="商店名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">商店地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shangdiandizhi" class="input" type="text" placeholder="商店地址">
			   </div>
			 </div> -->
			<el-form-item label="商店地址" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangdiandizhi" autocomplete="off" placeholder="商店地址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.shangdianbianhao) && `shangjia` == this.tableName){
      ...
      if((!this.ruleForm.shangdianmingcheng) && `shangjia` == this.tableName){
