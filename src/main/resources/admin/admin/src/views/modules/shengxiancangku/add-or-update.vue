<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="仓库面积" prop="cangkumianji">
          <el-input v-model="ruleForm.cangkumianji" 
              placeholder="仓库面积" clearable  :readonly="ro.cangkumianji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="仓库面积" prop="cangkumianji">
              <el-input v-model="ruleForm.cangkumianji" 
                placeholder="仓库面积" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cangkuweizhi = true;
          ...
          if(o=='cangkumianji'){
            this.ruleForm.cangkumianji = obj[o];
	    this.ro.cangkumianji = true;
            continue;
          }
