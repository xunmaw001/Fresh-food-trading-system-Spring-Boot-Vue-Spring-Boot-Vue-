<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="shangdianbianhao">
          <el-input v-model="ruleForm.shangdianbianhao" 
              placeholder="商户名称" clearable  :readonly="ro.shangdianbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户名称" prop="shangdianbianhao">
              <el-input v-model="ruleForm.shangdianbianhao" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springbootcug86/upload');
        } else {
