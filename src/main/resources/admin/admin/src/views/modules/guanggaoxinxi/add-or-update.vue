<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="广告类型" prop="guanggaoleixing">
          <el-input v-model="ruleForm.guanggaoleixing" 
              placeholder="广告类型" clearable  :readonly="ro.guanggaoleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="广告类型" prop="guanggaoleixing">
              <el-input v-model="ruleForm.guanggaoleixing" 
                placeholder="广告类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.guanggaoshipin" label="广告视频" prop="guanggaoshipin">
          <file-upload
          tip="点击上传广告视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.guanggaoshipin?ruleForm.guanggaoshipin:''"
          @change="guanggaoshipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.guanggaoshipin" label="广告视频" prop="guanggaoshipin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.guanggaoshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.guanggaofengmian" label="广告封面" prop="guanggaofengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.guanggaofengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	guanggaoleixing : false,
	guanggaoneirong : false,
	guanggaoshipin : false,
	fabushijian : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guanggaomingcheng = true;
          ...
          if(o=='guanggaoleixing'){
            this.ruleForm.guanggaoleixing = obj[o];
	    this.ro.guanggaoleixing = true;
            continue;
          }
	    ...
	    this.ro.guanggaoneirong = true;
          ...
          if(o=='guanggaoshipin'){
            this.ruleForm.guanggaoshipin = obj[o];
	    this.ro.guanggaoshipin = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.guanggaoneirong = this.ruleForm.guanggaoneirong.replace(reg,'../../../springbootcug86/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.guanggaoshipin!=null) {
		this.ruleForm.guanggaoshipin = this.ruleForm.guanggaoshipin.replace(new RegExp(this.$base.url,"g"),"");
	}




	if(this.ruleForm.guanggaofengmian!=null) {
		this.ruleForm.guanggaofengmian = this.ruleForm.guanggaofengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    guanggaoshipinUploadChange(fileUrls) {
	this.ruleForm.guanggaoshipin = fileUrls;
	this.addEditUploadStyleChange()
    },
