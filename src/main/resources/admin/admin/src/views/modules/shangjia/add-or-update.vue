<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shangdiantupian" label="商店图片" prop="shangdiantupian">
          <file-upload
          tip="点击上传商店图片"
          action="file/upload"
          :limit="3"
          ...
          @change="shangdiantupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shangdiantupian" label="商店图片" prop="shangdiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangdiantupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	money : false,
      ...
      rules: {
          shangdianbianhao: [
                { required: true, message: '商店编号不能为空', trigger: 'blur' },
          ],
          mima: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='shangdiantupian'){
            this.ruleForm.shangdiantupian = obj[o];
	    this.ro.shangdiantupian = true;
            continue;
          }
          if(o=='money'){
...
var objcross = this.$storage.getObj('crossObj');
    ...
    shangdiantupianUploadChange(fileUrls) {
